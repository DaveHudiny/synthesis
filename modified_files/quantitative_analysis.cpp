...
void define_belief_exploration(py::module& m, std::string const& vtSuffix) {
    ...
    // define functions to convert belief state to real belief
    belmdpexpl.def("get_belief_id", &storm::builder::BeliefMdpExplorer<Pomdp<ValueType>, ValueType>::getBeliefId, py::arg("mdp_state"));
    // belmdpexpl.def("get_current_mdp_state", &storm::builder::BeliefMdpExplorer<Pomdp<ValueType>, ValueType>::getCurrentMdpState);
    // belmdpexpl.def("get_current_belief_id", &storm::builder::BeliefMdpExplorer<Pomdp<ValueType>, ValueType>::getCurrentBeliefId);
    //computeRewardAtCurrentState
    // belmdpexpl.def("compute_reward_at_current_state", &storm::builder::BeliefMdpExplorer<Pomdp<ValueType>, ValueType>::computeRewardAtCurrentState, py::arg("reward"));
    //getBeliefsInMdp
    belmdpexpl.def("get_beliefs_in_mdp", &storm::builder::BeliefMdpExplorer<Pomdp<ValueType>, ValueType>::getBeliefsInMdp);
    //getBeliefsWithObservationInMdp
    belmdpexpl.def("get_beliefs_with_observation_in_mdp", &storm::builder::BeliefMdpExplorer<Pomdp<ValueType>, ValueType>::getBeliefsWithObservationInMdp, py::arg("observation"));
    //getExploredMdpState
    belmdpexpl.def("get_explored_mdp_state", &storm::builder::BeliefMdpExplorer<Pomdp<ValueType>, ValueType>::getExploredMdpState, py::arg("belief_id"));
    //getProbabilityEstimation
    belmdpexpl.def("get_probability_estimation", &storm::builder::BeliefMdpExplorer<Pomdp<ValueType>, ValueType>::getProbabilityEstimation, py::arg("mdp_state"));
    //getExploredMdp
    belmdpexpl.def("get_explored_mdp", &storm::builder::BeliefMdpExplorer<Pomdp<ValueType>, ValueType>::getExploredMdp);
    
    //BeliefManager
    py::class_<typename storm::storage::BeliefManager<Pomdp<ValueType>, ValueType>> belmgr(m, ("BeliefManager" + vtSuffix).c_str());
    //getBeliefManager
    belmdpexpl.def("get_belief_manager", &storm::builder::BeliefMdpExplorer<Pomdp<ValueType>, ValueType>::getBeliefManager);

    // getBeliefAsVector
    belmgr.def("get_belief_as_vector", &storm::storage::BeliefManager<Pomdp<ValueType>, ValueType>::getPublicBeliefAsVector, py::arg("belief_id"));
    // getNumberOfBeliefIds
    belmgr.def("get_number_of_belief_ids", &storm::storage::BeliefManager<Pomdp<ValueType>, ValueType>::getNumberOfBeliefIds);
