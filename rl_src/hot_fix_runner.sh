...
list_of_model_paths=("models_large")
num_of_iterations=3
...
#                 python3 experiment_runner.py --learning-rate=$learning_rate --batch-size=$batch_size --path-to-models=$model_path --random-start-simulator &
...
#                 python3 experiment_runner.py --learning-rate=$learning_rate --batch-size=$batch_size --path-to-models=$model_path &
