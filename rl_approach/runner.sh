python shield_v2.py --grid-model "obstacle" --learning_method "SAC" --eval-episodes 10 --constants "N=6" 
python shield_v2.py --grid-model "intercept" --learning_method "SAC" --eval-episodes 10 --constants "N=6,RADIUS=2"
python shield_v2.py --grid-model "rocks" --learning_method "SAC" --eval-episodes 10 --constants "N=6"
python shield_v2.py --grid-model "refuel" --learning_method "SAC" --eval-episodes 10 --constants "N=6,ENERGY=10"
python shield_v2.py --grid-model "evade" --learning_method "SAC" --eval-episodes 10 --constants "N=6,RADIUS=2"
python shield_v2.py --grid-model "avoid" --learning_method "SAC" --eval-episodes 10 --constants "N=6"
